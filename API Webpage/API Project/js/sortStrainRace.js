...
function strainRaceOptions(strainPosts) {
    ...
    for (let index = 0; index < Object.values(strainRaceItems).length; index++) {
        ...
        <div class="card w-75" style="width: 18rem;">
            <div class="card-body" class="card text-center">
                <h4><b>${Object.keys(strainPosts)[index]}</b></h4>
                <h6 class="card-subtitle mb-2 text-muted">${strainRaceItem.race}</h6>
                <p id="descList" class="card-text"></p>
                <p class="card-text"><b>ID: </b>${strainRaceItem.id}</p>
                <p class="card-text"><b>Flavors: </b>${strainRaceItem.flavors}</p>
                <p class="card-text"><b>Helps to treat: </b>${strainRaceItem.effects.medical}</p>
                <p class="card-text"><b>Positive Effects: </b>${strainRaceItem.effects.positive}</p>
                <p class="card-text"><b>Negative Effects: </b>${strainRaceItem.effects.negative}</p>
            </div>
        </div>`
    }
